...
import net.mijack.paperapp.zxing.utils.InactivityTimer;
import net.mijack.paperapp.zxing.utils.ScannerActivityHandler;
...
public final class ScannerActivity extends Activity implements SurfaceHolder.Callback {
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        try {
            ...
            // RuntimeException.
            if (handler == null) {
                handler = new ScannerActivityHandler(this, cameraManager, DecodeThread.ALL_MODE);
            }
